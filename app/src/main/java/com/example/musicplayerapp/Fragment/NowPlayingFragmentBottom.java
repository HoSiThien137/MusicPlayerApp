...
import static com.example.musicplayerapp.Activity.PlaylistActivity.ARTIST_TO_FRAG;
import static com.example.musicplayerapp.Activity.PlaylistActivity.PATH_TO_FRAG;
import static com.example.musicplayerapp.Activity.PlaylistActivity.SHOW_MINI_PLAYER;
import static com.example.musicplayerapp.Activity.PlaylistActivity.SONG_NAME_TO_FRAG;
        ...
        playPauseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(musicService != null){
                    ...
                    if(musicService.isPlaying())playPauseBtn.setImageResource(R.drawable.baseline_stop_circle);
                    else playPauseBtn.setImageResource(R.drawable.baseline_play_circle);
